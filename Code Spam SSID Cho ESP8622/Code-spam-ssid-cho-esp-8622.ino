...
// Danh sách 50 SSID Tiếng Việt CÓ DẤU siêu láo toét (Mạng Mở / Không mật khẩu)
...
uint8_t packet[128] = {
  ...
  0x01, 0x02, 0x03, 0x04, 0x05, 0x06, // Source MAC (Tạo ngẫu nhiên)
  0x01, 0x02, 0x03, 0x04, 0x05, 0x06, // BSSID (Tạo ngẫu nhiên)
  0x00, 0x00,                         // Sequence control
  // Timestamp
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x64, 0x00,                         // Beacon interval (100ms)
  0x01, 0x04                          // Capability info (Open System / Mạng mở không pass)
};

void setup() {
  // Đưa ESP8266 về chế độ phát gói tin thô
  WiFi.mode(WIFI_OFF);
...
void loop() {
  for (int i = 0; i < 50; i++) {
    // 1. Tạo Địa chỉ MAC ảo ngẫu nhiên hoàn toàn cho từng SSID
    ...
    // 3. Cấu hình tốc độ và Kênh phát
